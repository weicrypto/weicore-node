...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    weid.spawn.datadir.should.equal(home + '/.wei');
    weid.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.wei/weid'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.weid.spawn.datadir.should.equal('./data2');
  });
});

...
/**
 * Will return the path and weicore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'weicore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'weicore-node.json'))
  };
}

...
var weicorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = weicorenode.version;
  var create = weicorenode.scaffold.create;
  var add = weicorenode.scaffold.add;
  var start = weicorenode.scaffold.start;
  var remove = weicorenode.scaffold.remove;
  var callMethod = weicorenode.scaffold.callMethod;
  var findConfig = weicorenode.scaffold.findConfig;
  var defaultConfig = weicorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Wei database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make weicore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `weicore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ weicore-node add wallet-service');
      console.log('    $ weicore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ weicore-node remove wallet-service');
      console.log('    $ weicore-node remove insight-api');
      console.log();
    });

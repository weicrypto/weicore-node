...
module.exports.services.Wei = require('./lib/services/weid');
...
module.exports.cli.weicore = require('./lib/cli/weicore');
module.exports.cli.weicored = require('./lib/cli/weicored');

module.exports.lib = require('@weicrypto/weicore-lib');
